...
static int alarm_resume(struct platform_device *pdev)
{
	...
	update_timer_locked(&alarms[ANDROID_ALARM_ELAPSED_REALTIME_WAKEUP],
									false);
	/*[ECID:000000] ZTEBSP zhangbo 20120302, add power off alarm, start*/
	update_timer_locked(&alarms[ANDROID_ALARM_POWEROFF_WAKEUP],
									false);
	/*[ECID:000000] ZTEBSP zhangbo 20120302, add power off alarm, end*/
	spin_unlock_irqrestore(&alarm_slock, flags);
...
/*[ECID:000000] ZTEBSP zhangbo 20120302, add power off alarm, start*/
int zte_set_poweroff_alarm(unsigned long seconds)
{
	zte_set_poweroff_alarm_tps6586x(alarm_rtc_dev->dev.parent,seconds);
	return 0;
}
int zte_clear_poweroff_alarm(void)
{
	zte_clear_poweroff_alarm_tps6586x(alarm_rtc_dev->dev.parent);
	return 0;
}
/*[ECID:000000] ZTEBSP zhangbo 20120302, add power off alarm, end*/
