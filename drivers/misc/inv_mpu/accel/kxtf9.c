...
//[ECID:000000] ZTEBSP wanghaifei start 20120220, add macro
#define ACCEL_KXTF9_WHO_AM_I  (0x0F)
#define ACCEL_KXTF9_ID        (0x05)
//[ECID:000000] ZTEBSP wanghaifei end 20120220, add macro
