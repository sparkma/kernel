...
void dbg_gpio_status_show(void)
{
        printk("TEGRA_GPIO_PG1 : %02x %02x %02x %02x %02x %02x %06x\n",
               __raw_readl(GPIO_CNF(TEGRA_GPIO_PG1)),
               __raw_readl(GPIO_OE(TEGRA_GPIO_PG1)),
               __raw_readl(GPIO_OUT(TEGRA_GPIO_PG1)),
               __raw_readl(GPIO_IN(TEGRA_GPIO_PG1)),
               __raw_readl(GPIO_INT_STA(TEGRA_GPIO_PG1)),
               __raw_readl(GPIO_INT_ENB(TEGRA_GPIO_PG1)),
               __raw_readl(GPIO_INT_LVL(TEGRA_GPIO_PG1)));
}
