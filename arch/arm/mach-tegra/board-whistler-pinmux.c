...
//ZTEBSP DangXiao 20120317, set I2C drive strength for wake up failure case, start
...
//ZTEBSP DangXiao 20120317, set I2C drive strength for wake up failure case, end

static __initdata struct tegra_pingroup_config whistler_pinmux[] = {
	{TEGRA_PINGROUP_ATA,   TEGRA_MUX_GMI,           TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
...
//[ECID:000000] ZTEBSP maoke 20111001 end, for skate bring up
	...
	{TEGRA_PINGROUP_DTA,   TEGRA_MUX_RSVD4,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
	...
	{TEGRA_PINGROUP_DTD,   TEGRA_MUX_RSVD1,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
...
//[ECID:000000] ZTEBSP wanghaifei10129378 start 20111011, modify //IRRX and IRTX to pull normal
...
//[ECID:000000] ZTEBSP wanghaifei10129378 end 20111011
	{TEGRA_PINGROUP_KBCA,  TEGRA_MUX_KBC,           TEGRA_PUPD_PULL_UP,   TEGRA_TRI_NORMAL},
	{TEGRA_PINGROUP_KBCB,  TEGRA_MUX_SDIO2,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
	{TEGRA_PINGROUP_KBCC,  TEGRA_MUX_KBC,           TEGRA_PUPD_PULL_UP,   TEGRA_TRI_NORMAL},
	{TEGRA_PINGROUP_KBCD,  TEGRA_MUX_SDIO2,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
	{TEGRA_PINGROUP_KBCE,  TEGRA_MUX_RSVD4,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
	{TEGRA_PINGROUP_KBCF,  TEGRA_MUX_NAND,          TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
...
//[ECID:000000] ZTEBSP maoke 20111001 start, for skate bring up
	{TEGRA_PINGROUP_LDC,   TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_NORMAL,   TEGRA_TRI_TRISTATE},
//[ECID:000000] ZTEBSP maoke 20111001 end, for skate bring up
...
//[ECID:000000] ZTEBSP maoke 20111001 start, for skate bring up
	//[ECID:000000] ZTEBSP DangXiao 20111116 for BL GPIO
	...
	//{TEGRA_PINGROUP_LM1,   TEGRA_MUX_RSVD3,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
	//[ECID:0000] ZTEBSP maxiaoping 20120105 for MIMOSA backlight control --
	
	{TEGRA_PINGROUP_LPP,   TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_NORMAL},   //D23
	...
	//[ECIQ:0000] zhangzhao 2012-2-21 for 943t ics touch
	...
	{TEGRA_PINGROUP_SLXK,  TEGRA_MUX_SPI4,          TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
/*[ECID:000000] ZTEBSP wangbing 20111020, TEGRA_MUX_RSVD2, add temperature sense driver start */
...
/*[ECID:000000] ZTEBSP wangbing 20111020, add temperature sense driver end */
	...
	{TEGRA_PINGROUP_SPIF,  TEGRA_MUX_RSVD4,         TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
	...
	//[ECID:000000]ZTE BSP khl modify for pinmux config UARTB start
       {TEGRA_PINGROUP_UAD,   TEGRA_MUX_IRDA,      TEGRA_PUPD_NORMAL,   TEGRA_TRI_NORMAL},
    //[ECID:000000]ZTE BSP khl modify for pinmux config end
...
//[ECID:0000] ZTEBSP maxiaoping 20120105 for MIMOSA backlight control ++
struct tegra_pingroup_config lcd_lm1_pinmux = 
{
