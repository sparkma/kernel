...
#define MODEM_PWR_ON	TEGRA_GPIO_PX7   // I_MDM_PWR_ON
#define MODEM_RESET	TEGRA_GPIO_PV0   // I_MDM_RST
...
//[ECID:000000] ZTEBSP maoke 20111012 start, for AP+Modem ULPI
/* Icera 450 GPIO */
#define AP2MDM_ACK	TEGRA_GPIO_PK5  //TEGRA_GPIO_PZ0
#define MDM2AP_ACK	TEGRA_GPIO_PV2
#define AP2MDM_ACK2	TEGRA_GPIO_PX6
#define MDM2AP_ACK2	TEGRA_GPIO_PU6  // I_MDM2AP_ACK2
#define BB_RST_OUT      TEGRA_GPIO_PV3  // I_FRST_CBOOT
//[ECID:000000] ZTEBSP maoke 20111012 end, for AP+Modem ULPI
