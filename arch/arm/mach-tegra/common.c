...
//ZTEBSP DangXiao 20120328,start
enum e_lcd_vendor_type  LCD_Vendor_Type;
//ZTEBSP DangXiao 20120328,end
...
void tegra_assert_system_reset(char mode, const char *cmd)
{
	...
	if (cmd) {
		if (!strcmp(cmd, "recovery"))
			...
			reg |= BOOTLOADER_MODE;
/* [ECID:000000] ZTEBSP wangxiaomei start 20120320 modify enter recovery mode by PM register  */
		//else if (!strcmp(cmd, "forced-recovery"))
		else if (!strcmp(cmd, "RCM"))
/* [ECID:000000] ZTEBSP wangxiaomei end 20120320 modify enter recovery mode by PM register  */
...
//ZTEBSP DangXiao 20120514, start
/*
	Function: Get LCD vendor from bootloader cmdline
	autor: ZTEBSP DangXiao
*/
enum e_lcd_vendor_type get_lcd_vendor_type(void)
{
	return LCD_Vendor_Type;
}
static int __init tegra_board_panel_lcd_vendor_type(char *options)
{
	if (!strcmp(options, "nt35516_sharp"))
		LCD_Vendor_Type = panel_nt35516_sharp;
	else if (!strcmp(options, "nt35516_lead"))
		LCD_Vendor_Type = panel_nt35516_lead;
	else if (!strcmp(options, "nt35516_truly"))
		LCD_Vendor_Type = panel_nt35516_truly;
	else if (!strcmp(options, "nt35516_success"))
		LCD_Vendor_Type = panel_nt35516_success;
	else if (!strcmp(options, "nt35516_tianma"))
		LCD_Vendor_Type = panel_nt35516_tianma;
	else if (!strcmp(options, "nt35516_boe"))
		LCD_Vendor_Type = panel_nt35516_boe;	
	else if (!strcmp(options, "otm9608a_boe"))
		LCD_Vendor_Type = panel_otm9608a_boe;
	else
		return 0;
	printk("LCD Vendor Type is : %d!========== \n",LCD_Vendor_Type);
	return 1;
}
__setup("lcd_vendor=", tegra_board_panel_lcd_vendor_type);

//ZTEBSP DangXiao 2012514,end
