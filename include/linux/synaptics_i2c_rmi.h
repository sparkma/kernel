...
struct rmi_function_info {
	...
	__u8 data_offset;
	__u8 data_length;
	__u8 controlBase; //[ecid:0000] ztebsp zhangzhao add for 2202 tsc
	__u8 commandlBase; //[ecid:0000] ztebsp zhangzhao add for reset tsc 2012-6-1
	__u8 dataBase; //[ecid:0000] ztebsp zhangzhao add for reset tsc 2012-6-1
	__u8 querryBase; //[ecid:0000] ztebsp zhangzhao add for firmware update 2012-6-7
};
...
struct synaptics_rmi4 {
	...
	int hasF34;//[ecid:0000] ztebsp zhangzhao add for firmware update 2012-6-7
	struct rmi_function_info f34;//[ecid:0000] ztebsp zhangzhao add for firmware update 2012-6-7
