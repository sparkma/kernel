...
//[ECID:000000] ZTEBSP jiaobaocun 20120229 start, for codec
	...
	//	i2sclock *= 2;
	// NV Viraj 28-02-2012 : changed for BT SCO
	//if (i2s->reg_ctrl & TEGRA20_I2S_CTRL_BIT_FORMAT_DSP)
	//	i2sclock *= 2;
...
//[ECID:000000] ZTEBSP jiaobaocun 20120423 start, for codec
	/*Use the currently set clock value for furthur calculations*/
	i2sclock = clk_get_rate(i2s->clk_i2s);
//[ECID:000000] ZTEBSP jiaobaocun 20120423 start, for codec
	if (i2s->reg_ctrl & TEGRA20_I2S_CTRL_BIT_FORMAT_DSP)
		i2sclk_div = srate;
	else
...
static void tegra20_i2s_stop_playback(struct tegra20_i2s *i2s)
{
	...
	i2s->reg_ctrl &= ~TEGRA20_I2S_CTRL_FIFO1_ENABLE;
	tegra20_i2s_write(i2s, TEGRA20_I2S_CTRL, i2s->reg_ctrl);
	/* Wait for controller to transfer all samples */
	while ((tegra20_i2s_read(i2s, TEGRA20_I2S_STATUS) & TEGRA20_I2S_STATUS_FIFO1_BSY)&& cnt--)
		udelay(100);
}
