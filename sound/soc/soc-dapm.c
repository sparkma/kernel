...
/* This is to support custom declaration of dapm TLV control in tlv320aic326x.c*/
/*Function added by preetam*/
int update_power_tlv(struct snd_soc_dapm_widget *widget,
				   struct snd_kcontrol *kcontrol, int connect)
{
	return dapm_mixer_update_power(widget, kcontrol, connect);
}
EXPORT_SYMBOL_GPL(update_power_tlv);
