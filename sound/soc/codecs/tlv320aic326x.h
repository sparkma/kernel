...
//[ECID:000000] ZTEBSP jiaobaocun 20120309 start, for Codec wakeup 
/* Enable register caching on write */
//#define EN_REG_CACHE 1
//[ECID:000000] ZTEBSP jiaobaocun 20120309 end, for Codec wakeup 
#define MULTICONFIG_SUPPORT
...
#define CHRG_PUMP_CNTL_1	(PAGE_1 + 33)
#define CHRG_PUMP_CNTL_2	(PAGE_1 + 34)
#define CHRG_PUMP_CNTL_3	(PAGE_1 + 35)

#define RAMP_CNTL_R1		(PAGE_1 + 36)
#define RAMP_CNTL_R2		(PAGE_1 + 37)
//#define INT1_SEL_RM		(PAGE_1 + 39)
#define IN1L_SEL_RM		(PAGE_1 + 38)
...
struct aic3262_priv {
	...
	void *control_data;
#endif
	u8 *reg_buffer;	/* Local Register Buffer */
};
...
extern int aic3262_fm_pop_cntl(int val);
...
#endif
extern void spi_cs_en(unsigned int cs);
